...
class Wechat(object):
    ...
    def request_get_wechat_uuid(self):
        request = WechatGetSafeUUIDRequest(self.request_token)
    ...
    def request_check_safe_qrcode(self):
        request = WechatQRCodeCheckRequest(self.request_token)
        request.check("011hN-kqqTU8nawf")
