...
def signup(wechat_username, wechat_password, wechat_defualt_id, wecaht_token = None):
    ChestnutModelDao.create_chestnut_user(wechat_username, wechat_password, wechat_defualt_id, wecaht_token)
